<template>
    ...
    <div class="main-container">
        ...
        <export-sure ref="exportSureDialog" :show="flag" type="fcos_site_balance_log" :searchParam="siteBalanceLogTableData.searchParam" @close="handleClose" />
...
import {getSiteBalanceList,getSiteBalanceSum} from '@/addon/fcapi/api/api'
