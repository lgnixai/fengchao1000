...
namespace addon\fcos\app\adminapi\controller\order;

use addon\fcos\app\service\admin\order\OrderAddService;
use addon\fcos\app\service\admin\order\OrderService;
 ...
 * 订单列控制器
 * Class OrderAdd
 * @package addon\fcos\app\adminapi\controller\order
 */
class OrderAdd extends BaseAdminController
{
    ...
    public function add()
    {
        ...
        $this->validate($data, 'addon\fcos\app\validate\order\OrderAdd.add');
    ...
    public function edit(int $id)
    {
        ...
        $this->validate($data, 'addon\fcos\app\validate\order\OrderAdd.edit');
