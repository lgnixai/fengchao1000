...
namespace addon\fcapi\app\service\admin;
...
class MemberAccountService extends BaseAdminService
{
    public function __construct()
    {
        ...
        $res=(new SiteMember())->where([['site_id', '=', $this->site_id]])->find();
    ...
    public function getPage(array $where = [])
    {
        ...
        $search_model = $this->model->where([ [ 'member_account_log.member_id', '=', $this->member_id ] ])->withSearch([ 'join_member_id' => 'member_id', 'account_type', 'from_type', 'join_create_time' => 'create_time' ], $where)
            ->withJoin(
