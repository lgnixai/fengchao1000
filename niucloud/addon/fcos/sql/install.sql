-- ----------------------------
-- Table structure for {{prefix}}fcos_brand
-- ----------------------------
DROP TABLE IF EXISTS `{{prefix}}fcos_brand`;
CREATE TABLE `{{prefix}}fcos_brand`
(
...
-- ----------------------------
-- Table structure for {{prefix}}fcos_help
-- ----------------------------
DROP TABLE IF EXISTS `{{prefix}}fcos_help`;
CREATE TABLE `{{prefix}}fcos_help`
(
...
-- ----------------------------
-- Table structure for {{prefix}}fcos_notice
-- ----------------------------
DROP TABLE IF EXISTS `{{prefix}}fcos_notice`;
CREATE TABLE `{{prefix}}fcos_notice`
(
    `id`          int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
    `site_id`     int(11) NOT NULL COMMENT '站点id',
...
-- ----------------------------
-- Table structure for {{prefix}}fcos_order
-- ----------------------------
DROP TABLE IF EXISTS `{{prefix}}fcos_order`;
CREATE TABLE `{{prefix}}fcos_order`
(
    `id`                   int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
    `site_id`              int(11) NOT NULL COMMENT '站点id',
...
-- ----------------------------
-- Table structure for {{prefix}}fcos_shop_order
-- ----------------------------
DROP TABLE IF EXISTS `{{prefix}}fcos_shop_order`;
CREATE TABLE `{{prefix}}fcos_shop_order`
(
...
-- ----------------------------
-- Table structure for {{prefix}}fcos_order_add
-- ----------------------------
DROP TABLE IF EXISTS `{{prefix}}fcos_order_add`;
CREATE TABLE `{{prefix}}fcos_order_add`
(
    `id`           int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
    `site_id`      int(11) NULL DEFAULT NULL COMMENT '站点id',
...
-- ----------------------------
-- Table structure for {{prefix}}fcos_order_delivery
-- ----------------------------
DROP TABLE IF EXISTS `{{prefix}}fcos_order_delivery`;
CREATE TABLE `{{prefix}}fcos_order_delivery`
(
...
-- ----------------------------
-- Table structure for {{prefix}}fcos_order_delivery_real
-- ----------------------------
DROP TABLE IF EXISTS `{{prefix}}fcos_order_delivery_real`;
CREATE TABLE `{{prefix}}fcos_order_delivery_real`
(
...
-- ----------------------------
-- Table structure for {{prefix}}fcos_order_discount
-- ----------------------------
DROP TABLE IF EXISTS `{{prefix}}fcos_order_discount`;
CREATE TABLE `{{prefix}}fcos_order_discount`
(
...
-- ----------------------------
-- Table structure for {{prefix}}fcos_order_log
-- ----------------------------
DROP TABLE IF EXISTS `{{prefix}}fcos_order_log`;
CREATE TABLE `{{prefix}}fcos_order_log`
(
...
-- ----------------------------
-- Table structure for {{prefix}}fcos_fenxiao_member
-- ----------------------------
DROP TABLE IF EXISTS `{{prefix}}fcos_fenxiao_member`;
CREATE TABLE `{{prefix}}fcos_fenxiao_member`
(
...
-- ----------------------------
-- Table structure for {{prefix}}fcos_fenxiao_order
-- ----------------------------
DROP TABLE IF EXISTS `{{prefix}}fcos_fenxiao_order`;
CREATE TABLE `{{prefix}}fcos_fenxiao_order`
(
...
-- ----------------------------
-- Records of {{prefix}}fcos_brand
-- ----------------------------
INSERT INTO `{{prefix}}fcos_brand`
VALUES ('', 0, 'JD', '京东', 'addon/fcos/logo/jd.png', 1, 1690035304, 1690035304, '8');
INSERT INTO `{{prefix}}fcos_brand`
VALUES ('', 0, 'YTO', '圆通', 'addon/fcos/logo/yt.png', 1, 0, 0, '');
INSERT INTO `{{prefix}}fcos_brand`
VALUES ('', 0, 'STO-INT', '申通', 'addon/fcos/logo/st.png', 1, 0, 0, '');
INSERT INTO `{{prefix}}fcos_brand`
VALUES ('', 0, 'DOP', '德邦', 'addon/fcos/logo/db.png', 1, 0, 0, '');
INSERT INTO `{{prefix}}fcos_brand`
VALUES ('', 0, 'SF', '顺丰', 'addon/fcos/logo/sf.png', 1, 0, 0, '');
INSERT INTO `{{prefix}}fcos_brand`
VALUES ('', 0, 'JT', '极兔', 'addon/fcos/logo/jt.png', 1, 0, 0, '');
INSERT INTO `{{prefix}}fcos_brand`
VALUES ('', 0, 'ZTO', '中通', 'addon/fcos/logo/zt.png', 1, 0, 0, '');
INSERT INTO `{{prefix}}fcos_brand`
VALUES ('', 0, 'YUND', '韵达', 'addon/fcos/logo/yd.png', 1, 0, 0, '');
INSERT INTO `{{prefix}}fcos_brand`
VALUES ('', 0, 'CNSD', '菜鸟速递', 'addon/fcos/logo/cn.png', 1, 0, 0, '');
INSERT INTO `{{prefix}}fcos_brand`
VALUES ('', 0, 'CAINIAO', '菜鸟裹裹', 'addon/fcos/logo/cnsd.png', 1, 0, 0, '');
INSERT INTO `{{prefix}}fcos_brand`
VALUES ('', 0, 'EMS', 'EMS', 'addon/fcos/logo/ems.png', 1, 0, 0, '');
INSERT INTO `{{prefix}}fcos_brand`
VALUES ('', 0, 'KY', '跨越速运', 'addon/fcos/logo/ky.png', 1, 0, 0, '0');
INSERT INTO `{{prefix}}fcos_brand`
VALUES ('', 0, 'BEST', '百事速运', 'addon/fcos/logo/bs.png', 1, NULL, NULL, NULL);
...
VALUES (19, '订单状态', 'jhkd_order_status',
        ...
        'fcos addon', 1703695191, 1705993389);
DELETE
FROM `{{prefix}}sys_dict`
