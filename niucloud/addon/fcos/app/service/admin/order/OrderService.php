...
namespace addon\fcos\app\service\admin\order;
...
use addon\fcos\app\model\order\OrderLog;
/**
 * 订单列服务层
 * Class OrderService
 * @package addon\fcos\app\service\admin\order
 */
class OrderService extends BaseAdminService
{
    ...
    public function getLink()
    {
        ...
        return $wap_url.'/addon/fcos/pages/ordersubmit';
    }
