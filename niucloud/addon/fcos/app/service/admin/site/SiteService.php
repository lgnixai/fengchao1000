...
use addon\fcos\app\model\site\SiteAccount;
use addon\fcos\app\model\site\SiteBalanceLog;
...
class SiteService extends BaseAdminService
{
    ...
    public function getPage(array $where = [])
    {
        ...
        $field = 'site_balance_log.id,  site_balance_log.site_id, site_balance_log.account_type, site_balance_log.account_data,site_balance_log.account_sum, site_balance_log.from_type, site_balance_log.related_id, site_balance_log.create_time, site_balance_log.memo';
        $site_where = [];
