...
namespace addon\fcos\app\model\tkjhkdorder;
 ...
 * 订单列模型
 * Class Tkjhkdorder
 * @package addon\fcos\app\model\tkjhkdorder
 */
class Tkjhkdorder extends BaseModel
{
    ...
    {
        return $this->hasOne(\addon\fcos\app\model\orderdelivery\OrderDelivery::class, 'order_id', 'order_id');
    }

    public function deliveryRealInfo()
    {
        return $this->hasOne(\addon\fcos\app\model\OrderDeliveryReal::class, 'order_id', 'order_id');
    }
