...
namespace addon\fcos\app\adminapi\controller\shop_order;

use addon\fcos\app\service\admin\shop\OrderService;
use core\base\BaseAdminController;
use addon\fcos\app\service\admin\shop_order\ShopOrderService;
 ...
 * 商城发单控制器
 * Class ShopOrder
 * @package addon\fcos\app\adminapi\controller\shop_order
 */
class ShopOrder extends BaseAdminController
{
    ...
    */
    ...
    public function add(){
        ...
        $this->validate($data, 'addon\fcos\app\validate\shop_order\ShopOrder.add');
    ...
    public function edit(int $id){
        ...
        $this->validate($data, 'addon\fcos\app\validate\shop_order\ShopOrder.edit');
