...
namespace addon\fcos\app\adminapi\controller\help;

use core\base\BaseAdminController;
use addon\fcos\app\service\admin\help\HelpService;


/**
 * 帮助中心控制器
 * Class Help
 * @package addon\fcos\app\adminapi\controller\help
 */
class Help extends BaseAdminController
{
    ...
    public function add()
    {
        ...
        $this->validate($data, 'addon\fcos\app\validate\help\Help.add');
    ...
    public function edit(int $id)
    {
        ...
        $this->validate($data, 'addon\fcos\app\validate\help\Help.edit');
