...
namespace addon\fcos\app\adminapi\controller\tkjhkdorder;

use app\service\admin\member\MemberService;
use core\base\BaseAdminController;
use addon\fcos\app\service\admin\tkjhkdorder\TkjhkdorderService;


/**
 * 订单列控制器
 * Class Tkjhkdorder
 * @package addon\fcos\app\adminapi\controller\tkjhkdorder
 */
class Tkjhkdorder extends BaseAdminController
{
    ...
    */
    ...
    public function add(){
        ...
        $this->validate($data, 'addon\fcos\app\validate\tkjhkdorder\Tkjhkdorder.add');
    ...
    public function edit($id){
        ...
        $this->validate($data, 'addon\fcos\app\validate\tkjhkdorder\Tkjhkdorder.edit');
