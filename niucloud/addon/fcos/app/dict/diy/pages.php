...
return [
    'DIY_FCOS_INDEX' => [
        'fcos_index_one' => [ // 页面标识
            "title" => "快递首页", // 页面名称
            'cover' => 'addon/fcos/diy/cover/cover.png', // 页面封面图
            'preview' => 'addon/fcos/diy/cover/cover.png', // 页面预览图
            'desc' => '', // 页面描述
                    ...
                    [
                        ...
                        "list" =>[
                            [
                                ...
                                "imageUrl" =>"addon/fcos/diy/index/banner.png",
                                "imgWidth" =>720,
                                "imgHeight" =>360,
                                "id" =>"7jezrytkabg0",
                                "width" =>375,
                    ...
                    [
                        ...
                        "list" =>[
                            [
                                ...
                                "imageUrl" =>"addon/fcos/diy/index/kuaidi.png",
                                "label" => [
                                    "control" =>false,
                                    "text" =>"热门",
                                    "textColor" =>"#FFFFFF",
                            ...
                            [
                                "id" =>"2720qf5lnf40",
                                "title" =>"寄重货",
                                "imageUrl" =>"addon/fcos/diy/index/kuaiyun.png",
                                "imgWidth" =>200,
                                "imgHeight" =>200,
                                "link" => [
                                    "parent" =>"FCOS_LINK",
                            ...
                            [
                                "id" =>"5o9su1q1qs80",
                                "title" =>"违禁品",
                                "imageUrl" =>"addon/fcos/diy/index/weijinpin.png",
                                "imgWidth" =>200,
                                "imgHeight" =>200,
                                "link" => [
                                    "parent" =>"FCOS_LINK",
                            ...
                            [
                                "id" =>"4i1iloxfmfi0",
                                "title" =>"补差价",
                                "imageUrl" =>"addon/fcos/diy/index/buchajia.png",
                                "imgWidth" =>200,
                                "imgHeight" =>200,
                                "link" => [
                                    "parent" =>"FCOS_LINK",
    ...
    'DIY_FCOS_MEMBER_INDEX' => [
        'fcos_member_first' => [ // 页面标识
            "title" => "聚合快递个人中心", // 页面名称
            'cover' => '', // 页面封面图
            'preview' => '', // 页面预览图
            'desc' => '', // 页面描述
