  ...
  <el-dialog v-model="showDialog" :title="title" width="500px" class="diy-dialog-wrap" :destroy-on-close="true">
    <el-form :model="formData" label-width="120px" ref="formRef" :rules="formRules" class="page-form"
      ...
      <el-form-item :label="t('api_key')">
        <el-input v-model.trim="formData.api_key" maxlength="16"   class="input-width" />
      </el-form-item>
      <el-form-item :label="t('api_secret')">
        <el-input v-model.trim="formData.api_secret" maxlength="32"   class="input-width"/>
      </el-form-item>
      <el-form-item :label="t('callbackUrl')" prop="callbackUrl">
...
import {addApi, getApiList, getNewApi} from '@/addon/fcapi/api/api'
