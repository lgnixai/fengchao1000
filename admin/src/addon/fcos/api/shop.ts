...
export function cancelOrder(param: any) {
    return request.post('fcos/shop/order/cancelorder', param)
}
...
export function preOrder(param: any) {
    return request.post('fcos/shop/order/preorder', param)
}
...
export function getSendAddress(param: any) {
    return request.get('fcos/shop/order/sendaddress', param)
}
...
export function getOrderList(params: Record<string, any>) {
    return request.get('fcos/shop/order/lists', { params })
}
...
export function getOrderDeliveryType(params: Record<string, any>) {
    return request.get(`fcos/shop/order/delivery/type`, { params })
}
...
export function orderDelivery(params: Record<string, any>) {
    return request.post(`fcos/shop/order/delivery`, params)
}
