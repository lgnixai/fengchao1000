...
import {
  ...
  getSendAddress,
  cancelOrder,
} from "@/addon/fcos/api/shop";
import DeliveryAction from "@/addon/fcos/views/shop_order/components/delivery-action.vue";
import OrderNotes from "@/addon/fcos/views/shop_order/components/order-notes.vue";
