  ...
  <el-dialog v-model="showDialog" title="快递鸟" width="580px" :destroy-on-close="true">
    <el-form :model="formData" label-width="140px" ref="formRef" :rules="formRules" class="page-form"
      ...
      <el-form-item label="常用导航">
        <el-button>
          <a href="https://open.yunyangwl.com/#/personalCenter" target="_blank">快递鸟文档</a>
        </el-button>
      </el-form-item>
    </el-form>
...
import { getDeliveryInfo, editDelivery } from "@/addon/fcos/api/delivery";
...
const setFormData = async (row: any = null) => {
  ...
  if (row) {
    const data = await (await getDeliveryInfo(row.delivery_type)).data;
