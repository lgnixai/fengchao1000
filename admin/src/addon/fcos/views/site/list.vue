...
<!--              </el-button>-->
              ...
              <el-button type="primary" class="mt-[5px] !ml-[0]" link @click="importEvent(row)">{{
                  t('managePrice')
                }}
              </el-button>
...
import { t } from '@/lang'
import { getSiteList } from '@/addon/fcos/api/site'
...
// import BalanceEdit from '@/addon/fcos/views/site/components/site-balance-edit.vue'
...
const editEvent = (data: any) => {
    router.push('/fcos/site/price/template_edit?site_id=' + data.site_id)
}

const importEvent = (data: any) => {
    router.push('/fcos/site/import/index?site_id=' + data.site_id)
}
