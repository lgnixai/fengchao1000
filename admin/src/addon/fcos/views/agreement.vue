        ...
        <el-card class="box-card !border-none" shadow="never">
            ...
            <div class="mt-[20px]">
                <el-table :data="agreementTableData.data" size="large" v-loading="agreementTableData.loading">
                    ...
                    <el-table-column prop="type_name" :label="t('typeName')" min-width="100"
...
import { t } from '@/lang'
import { getAgreementList } from '@/addon/fcos/api/agreement'
...
const editEvent = (data: any) => {
    router.push(`/fcos/agreement_edit?key=${data.agreement_key}`)
}
