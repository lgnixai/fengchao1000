<template>
    <div class="main-container">
        ...
        <el-card shadow="never" class="mt-[15px] !border-none">
            ...
            <el-row>
                <el-col :span="4" class="cursor-pointer" @click="router.push({ path: '/fcos/order/index', query: {status: 1}})">
                    <div class="ml-[10px]">
                ...
                <el-col :span="4" class="cursor-pointer" @click="router.push({ path: '/fcos/order/index', query: {status: 2}})">
                ...
                <el-col :span="4" class="cursor-pointer" @click="router.push({ path: '/fcos/order/index', query: {status: 3}})">
                ...
                <el-col :span="4" class="cursor-pointer" @click="router.push({ path: '/fcos/order/refund'})">
                ...
                <el-col :span="4" class="cursor-pointer" @click="router.push({ path: '/fcos/goods/list'})">
                ...
                <el-col :span="4" class="cursor-pointer" @click="router.push({ path: '/fcos/goods/list', query: {status: 0}})">
...
import {
    getfcosCountList,
    getfcosTodayCountList,
    getfcosYesterdayCountList,
    getfcosStat,
    getfcosOrderStat,
    getfcosGoodsStat
} from '@/addon/fcos/api/fcos'
...
const getStatInfoFn = async () => {
    let statTotalData = await (await getfcosCountList()).data
    for( let i in statTotalData){
        statTotalData[i] = Number(statTotalData[i])

    }
    statTotal.value = statTotalData
    statToday.value = await (await getfcosTodayCountList()).data
    statYesterday.value = await (await getfcosYesterdayCountList()).data
    statOrder.value = await (await getfcosOrderStat()).data
    statGoods.value = await (await getfcosGoodsStat()).data
    statCount.value = await (await getfcosStat()).data
    setTimeout(() => {
        drawChart('')
        drawChartTo('')
    }, 20)
